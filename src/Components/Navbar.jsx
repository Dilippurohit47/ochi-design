...
const Navbar = () => {
  return (
    <div
      className=" fixed z-[9999] w-full px-20 py-6  bg-zinc-900 flex justify-between items-center"
    ...
    >
      ...
      <div className="links relative   flex gap-5 ">
            ...
            <>
              ...
              >
                <p
                  href=""
                  key={index}
                  className={`  capitalize font-extralight transition-all ease-in-out duration-[0.4s] group-hover:translate-y-[-25px]    ${
                    index === 4 && ""
                  }`}
                >
                  {item}
                ...
                <p
                  href=""
                  key={index}
                  className={` capitalize  group-hover:translate-y-[-28px]  transition-all ease-in-out duration-[0.4s] font-extralight ${
                    index === 4 && "ml-[0vw] "
                  }`}
                >
                  {item}{" "}
