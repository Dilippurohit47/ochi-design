...
const Navbar = () => {
  return (
    <div className=' fixed z-[9999] w-full px-20 py-6  flex justify-between items-center' style={{ fontFamily: 'Neue Montreal' }}>
      <div className='logo'>
...
<br/> 
<p className={`h-[1px] group-hover:translate-x-[0] w-[auto] mt-[-3vh]  transition-all ease-in-out duration-[0.4s] bg-[#fffffffc] text-[#ffffff00] translate-x-[-4.5vw] ${index === 4 && 'w-[4.9vw] ml-[0vw] translate-x-[-10.5vw]'} `}>w</p>
